...
const GET_RATED_MOVIES_REQUEST = "GET_RATED_MOVIES_REQUEST";
const GET_RATED_MOVIES_SUCCESS = "GET_RATED_MOVIES_SUCCESS";
const GET_RATED_MOVIES_FAILURE = "GET_RATED_MOVIES_FAILURE";
